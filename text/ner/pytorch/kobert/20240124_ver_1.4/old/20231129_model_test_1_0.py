...
def main():
    ...
    parser.add_argument('--dummy_label')
    ...
    new_test_idx_list = []
    test_string_split_list = []
    for test_string, test_idx in zip(test_string_list, test_idx_list):
        test_string_split = test_string.split(' ')
        if len(test_string_split) > 200:
            pre_start = 0
            pre_end = 200
            while True:
