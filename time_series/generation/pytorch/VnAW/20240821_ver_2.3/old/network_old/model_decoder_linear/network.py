...
class VnAW(nn.Module):
    def __init__(self, x_len, y_len, embed_type, d_model, d_ff, n_heads,
                 temporal_type, temporal_length,
                 encoder_layer_num, encoder_feature_length, encoder_activation,
                 decoder_layer_num, decoder_feature_length, decoder_activation,
    ...
    def forward(self, x, x_mark, y, y_mark,
        ...
        dec_out = self.decoder(
            y=dec_emb, 
            encoder_result=enc_emb,
            look_ahead_mask=look_ahead_mask,
            encoder_decoder_mask=enc_dec_mask,
        )

        # projection
        result = self.conv(dec_out)
