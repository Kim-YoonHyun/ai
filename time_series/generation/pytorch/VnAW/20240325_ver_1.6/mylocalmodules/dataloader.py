...
class VnawDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        x_mark = self.x_mark_list[idx]
        y_mark = self.y_mark_list[idx]
        
        self_mask = self.self_mask_list[idx]
        la_mask = self.la_mask_list[idx]

        return x, x_mark, self_mask, y, y_mark, la_mask
...
def get_dataloader(x_list, y_list,
    ...
    dataset = VnawDataset(
        x_list=x_list,
        y_list=y_list,
        x_mark_list=x_mark_list,
        y_mark_list=y_mark_list,
