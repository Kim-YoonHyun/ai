...
def fixed_max_norm(df, norm, bos_num=None):
...
class VnawDataset(Dataset):
    def __init__(self, dataset_path, x_name_list, y_name_list, mark_name_list, scale, norm, n_heads, bos_num=None):
    ...
    def __getitem__(self, idx):
        ...
        if self.scale == 'fixed-max':
            x_df = fixed_max_norm(x_df, self.norm, self.bos_num)
            y_df = fixed_max_norm(y_df, self.norm, self.bos_num)
