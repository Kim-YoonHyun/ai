...
def main():
    ...
    for img_name, pred_label, pred_label_color in zip(img_name_list, pred_label_ary, pred_label_color_ary):
        ...
        os.makedirs(f'{result_save_path}/{golf_name}_test_result/label', exist_ok=True)
        os.makedirs(f'{result_save_path}/{golf_name}_test_result/label_color', exist_ok=True)
        os.makedirs(f'{result_save_path}/{golf_name}_test_result/label_merge', exist_ok=True)
        cv2.imwrite(f'{result_save_path}/{golf_name}_test_result/label/{img_name}', pred_label)        
        cv2.imwrite(f'{result_save_path}/{golf_name}_test_result/label_color/{img_name}', pred_label_color)
    ...
    for golf_name in golf_name_list:
        ...
        cv2.imwrite(f'{result_save_path}/{golf_name}_test_result/label_merge/pred_label_merge.png', pred_label_merge)
        cv2.imwrite(f'{result_save_path}/{golf_name}_test_result/label_merge/pred_label_color_merge.png', pred_label_color_merge)
